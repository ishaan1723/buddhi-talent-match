...
# Mock Freelancer Data (Rates scaled to Indian Rupees ₹/hr)
MOCK_FREELANCERS = [
    ("Rohan Mehta", "rohan.mehta@example.com", "https://www.linkedin.com/in/rohan-mehta-ai", "LLM Integrations", 3, 2500.00),
    ("Priya Sharma", "priya.sharma@example.com", "https://www.linkedin.com/in/priya-cv", "Computer Vision", 4, 5000.00),
    ("Aarav Patel", "aarav.patel@example.com", "https://www.linkedin.com/in/aarav-langchain", "LangChain & Agents", 2, 2000.00),
    ("Sneha Reddy", "sneha.reddy@example.com", "https://www.linkedin.com/in/sneha-ds", "Data Science & NLP", 5, 6000.00),
    ("Vikram Singh", "vikram.singh@example.com", "https://www.linkedin.com/in/vikram-llm", "LLM Finetuning", 3, 3500.00)
]

# Mock Job Data (Budgets scaled to Indian Rupees ₹/hr)
MOCK_JOBS = [
    (
